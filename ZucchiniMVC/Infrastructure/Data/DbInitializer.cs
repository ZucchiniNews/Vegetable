    ...
    public class DbInitializer
    {
        ...
        public static async Task SeedSubscriptionTypesAsync(ApplicationDbContext context)
        {
            if (!context.Plans.Any())
            {
                ...
                {
                    new Plan { Name = "Weekly", Description = "Breaking news access, Weekly recap newsletter", Price = 10, DurationInDays = 7 },
                    new Plan { Name = "Monthly", Description = "Unlimited news access, Daily morning briefings, Ad-free experience", Price = 49, DurationInDays = 30 },
                    new Plan { Name = "Yearly", Description = "Save 15% annually, All Monthly benefits, Exclusive in-depth reports", Price = 500, DurationInDays = 365 }
                };
